...
function modTick()
{
  if(timerActive == true) {
        ...
        if(countdown >= 80)
        {
            ...
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+1,mY,mZ),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-1,mY,mZ),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX,mY,mZ+1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX,mY,mZ-1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+1,mY,mZ-1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+1,mY,mZ+1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+2,mY,mZ),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+2,mY,mZ-1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+2,mY,mZ+1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-1,mY,mZ-1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-1,mY,mZ+1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-2,mY,mZ),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-2,mY,mZ+1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-2,mY,mZ-1),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX,mY,mZ-2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+1,mY,mZ-2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+2,mY,mZ-2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-1,mY,mZ-2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX-2,mY,mZ-2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX,mY,mZ+2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
            Level.setChestSlot(cX,cY,cZ,cSlot,getTile(mX+1,mY,mZ+2),0,Level.getChestSlotCount(cX,cY,cZ,cSlot)+1);
